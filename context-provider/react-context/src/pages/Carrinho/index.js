...
function Carrinho() {
  ...
  /* hook useMemo =  fara com que o valor da CONST TOTAL só renderize
   quando ocorrer alguma mudança nas variaveis passadas no parâmetro.   */
    ...
    <Container>
      ...
      <PagamentoContainer>
        ...
        <Select
          ...
          onChange={(event) => {
            mudarFormaPagamento(event.target.value)
          }}>
